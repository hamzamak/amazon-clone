    ...
    <header>
        ...
        <div className='flex items-center bg-amazon_blue p-1 flex-grow py-2'>
            <div className='mt-2 flex items-center flex-grow sm:flex-grow-0'>
                <Image src='https://links.papareact.com/f90' width={150} height={40} style={{objectFit:"contain",width :150, height :40}} alt='logo amazon' className='cursor-pointer' onClick={()=> router.push('/')} />
            </div>
            {/* Search Bar  */}
